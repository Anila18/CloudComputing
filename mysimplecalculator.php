...
input[type=submit]{
 padding:10px;  font-size:16px; cursor:pointer;border:none; background:#00FFFF; color:#00FFFF; width:300px; height:50px;
}
input[type=reset]{
 padding:10px;  font-size:16px;cursor:pointer; border:none;background:#00FFFF; color:#00FFFF; height:50px;
}
